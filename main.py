...
starting_currency_box = Box(master_box, border=border_width)
...
starting_amount_box = Box(master_box, border=border_width)
...
desired_currency_box = Box(master_box, border=border_width)
...
exchange_rate_box = Box(master_box, border=border_width)
# Create label for the starting amount text entry box
